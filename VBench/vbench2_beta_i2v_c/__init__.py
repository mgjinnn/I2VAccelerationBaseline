...
from VBench.vbench2_beta_i2v_c.utils import init_submodules, save_json, load_json
from VBench.vbench import VBench
        ...
        for dimension in dimension_list:
            try:
                if dimension in self.i2v_dims:
                    dimension_module = importlib.import_module(f'VBench.vbench2_beta_i2v_c.{dimension}')
                else:
                    dimension_module = importlib.import_module(f'VBench.vbench.{dimension}')
