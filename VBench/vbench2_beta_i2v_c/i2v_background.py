...
from VBench.vbench2_beta_i2v_c.utils import load_video, load_i2v_dimension_info, dreamsim_transform, dreamsim_transform_Image
import logging
...
def compute_i2v_background(json_dir, device, submodules_list, **kwargs):
    ...
    dream_model, preprocess = dreamsim(pretrained=True, cache_dir="./models/dreamsim/")
